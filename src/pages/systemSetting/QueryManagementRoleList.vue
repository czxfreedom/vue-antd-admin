...
import {getManagementRoleList,deleteManagementRole} from '@/services/managementRole'
...
export default {
  ...
  methods: {
    ...
    addNew () {
      this.$router.push('/system/ManagementRole/1/0')
    ...
    getList(pageNum,pageSize){
        getManagementRoleList(pageNum,pageSize).then(result => {
          this.dataSource = []
    ...
    deleteManagementRole(id){
      deleteManagementRole(id).then(result=>{
