...
export default {
  ...
  methods: {
    ...
    updateCurrencyRateSetting(id){
      ...
      updateCurrencyRateSetting(parseInt(id),this.formData.categoryId,this.formData.topic,this.formData.content,this.formData.isDeleted).then(
       result=>{
    ...
    createCurrencyRateSetting(){
      createCurrencyRateSetting(this.formData.categoryId,this.formData.topic,this.formData.content).then(
       result=>{         
         if (result.data.status == 0){
              message.success("success")
              this.$closePage(this.$route,"/list/CurrencyRateSettings")
